...
При создании плана тестирования нам необходимо разбить свой продукт на более мелкие компоненты. Это позволит вам определить лучший процесс тестирования в зависимости от типа создаваемого продукта тоесть:
- Выявите все функции нашего продукта
...
**Определите типы тестирования.** После того, как мы определили объем, нужно определить, какие випы тестирования необходимо выполнить. 
...
**Критерии приостановки** — это условия, которые требуют временной остановки тестирования. То есть статуст теста Failed, bloked, skipped...
...
# Шаг 7. Спланирование тестовой среды
